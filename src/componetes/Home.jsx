          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="text-yellow-300">Dr. Kabiru Gwarzo Academy</span>
             ...
             <div className="flex items-center justify-center gap-2 text-blue-100 mb-8">
              ...
              <span>No. 296 Layin Road Safety, Maikalwa Naibawa Zaria Road, Kumbotso LGA, Kano-Nigeria</span>
            </div>
             </div>
           ...
           <div className="flex flex-col sm:flex-row gap-4 justify-center">
               ...
               <Link
                 to="/about"
                 className="border-2 border-yellow-400 text-yellow-500 px-8 py-4 rounded-xl font-semibold hover:bg-yellow-500 hover:text-blue-900 transition-all duration-300 backdrop-blur-sm bg-white/10 shadow-xl"
               >
                 Learn More
             </Link>
        </div>
